                ...
                <React.Fragment key={userStat.user_id}>
                  ...
                  >
                    ...
                    <td className="px-2 sm:px-4 py-2 whitespace-nowrap">
                      <div className="flex items-center">
                        <div className="w-8 h-8 sm:w-10 sm:h-10 bg-gradient-to-r from-blue-500 to-blue-600 rounded-full flex items-center justify-center text-white font-bold shadow-md flex-shrink-0">
                        ...
                        <div className="ml-2 sm:ml-3">
                          ...
                          <div className="flex items-center space-x-2 text-xs text-gray-600 dark:text-gray-400 mt-1 sm:hidden">
                            <div className="flex items-center space-x-1">
                              <Crown className="w-3 h-3 text-purple-500 dark:text-purple-400 flex-shrink-0" />
                              <span className="text-purple-600 dark:text-purple-400 font-semibold">{userStat.rounds_won || 0} Vitórias</span>
                            </div>
                          </div>
                        </div>
                      </div>
                    ...
                    <td className="px-2 sm:px-4 py-2 whitespace-nowrap text-center">
                      <div className="flex items-center justify-center">
                        <div className="flex items-center space-x-1 bg-yellow-100 dark:bg-yellow-800 rounded-full px-2 py-1">
                          <Trophy className="w-3 h-3 text-yellow-600 dark:text-yellow-300" />
                    ...
                    <td className="px-2 sm:px-4 py-2 whitespace-nowrap text-center">
                      <div className="flex items-center justify-center">
                        <div className="flex items-center space-x-1 bg-green-100 dark:bg-green-800 rounded-full px-2 py-1">
                          <Target className="w-3 h-3 text-green-600 dark:text-green-300" />
                    ...
                    <td className="px-2 sm:px-4 py-2 whitespace-nowrap text-center hidden lg:table-cell">
                      <div className="flex items-center justify-center">
                        <div className="flex items-center space-x-1 bg-purple-100 dark:bg-purple-800 rounded-full px-2 py-1 cursor-pointer hover:bg-purple-200 dark:hover:bg-purple-700 transition-colors"
                          ...
                          {userStat.rounds_won > 0 && (
                            expandedRows.has(userStat.user_id)
                              ? <ChevronUp className="w-3 h-3 text-purple-600 dark:text-purple-300" />
                              : <ChevronDown className="w-3 h-3 text-purple-600 dark:text-purple-300" />
                          )}
                        </div>
                      </div>
                    </td>
                    <td className="px-2 sm:px-4 py-2 whitespace-nowrap text-center hidden md:table-cell">
                      <span className="text-xs font-medium text-gray-700 dark:text-gray-300">
                        {userStat.total_bets}
                      </span>
                    </td>
                    <td className="px-2 sm:px-4 py-2 whitespace-nowrap text-center hidden sm:table-cell">
                      <span className={`inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium ${getAccuracyColor(accuracy)}`}>
                        {accuracy.toFixed(0)}%
                      </span>
                    </td>
                  </tr>
                      ...
                      <td colSpan={7} className="px-4 sm:px-6 py-4">
                        <div className="flex flex-col space-y-3">
                          <div className="flex items-center space-x-2">
                            ...
                            Vitórias de {userStat.user.name}:
                            </span>
                          </div>
